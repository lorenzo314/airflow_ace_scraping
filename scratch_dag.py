...
def pipeline_scrape_ace_data(
    ...
    Parameters
        ...
        return_df : bool, optional
            Keyword.
            Set to True to return a dataframe of resampled ACE features.
            The default is True.
    ...
    data_scraping_directory = \
        create_directory(
            directory_path, measuring_devices, monthly=monthly
        )

    # getting the dates over the selected time interval
    dates_in_time_interval = \
        get_dates_in_time_interval(
            start_date, end_date, monthly=monthly
        )

    # Building complete urls for each date and each measuring devices,
    ...
    # optional resampling of the manually downloaded data
